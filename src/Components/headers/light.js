 ...
 */
export const NavLink = tw.a` text-primary-800
...
export const NavToggle = tw.button`
  px-4 py-2 rounded lg:hidden z-20 focus:outline-none hocus:text-primary-500 transition duration-300
`;
  ...
  const defaultLinks = [
    <NavLinks key={1}>
...

      {
        ...
        :
        <LogoutLink css={roundedHeaderButton && tw`rounded-full`} onClick={handleLogOut}>
          Log Out        
        </LogoutLink>
